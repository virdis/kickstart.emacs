    ...
    (use-package general
      ...
      ;;   "b j" '(consult-bookmark :wk "Bookmark jump"))
       ...
       (start/leader-keys
        ...
        "m u r" '(lsp-ui-peek-find-references :wk "Lsp find references"))
...
#+begin_src emacs-lisp
 ;;  jadd-to-list 'default-frame-alist '(alpha-background . 90)) ;; For all new frames henceforth
#+end_src
...
(set-face-attribute 'default nil
  ...
  (add-to-list 'default-frame-alist '(font . "Iosevka Nerd Font 17")) ;; Set your favorite font
...
** Lsp-Mode
Langauge server protocol Support for Emacs 
