...
#+begin_src emacs-lisp
    (use-package general
      ...
      (start/leader-keys
        ...
        "f f" '(projectile--find-file :wk "Projectile find files")
        "f g" '(projectile-ripgrep :wk "Ripgrep search in files")
        "f l" '(consult-line :wk "Find line")
        "f i" '(consult-imenu :wk "Imenu buffer locations"))

      (start/leader-keys
        "c" '(:ignore t :wk "Code/Lsp")
        "c l" '(lsp-mode t :wk "Start Lsp")
        ...
        "c s" '(yas-insert-snippet :wk "Insert snippet")
...
#+end_src
** Search Ripgrep
Allows to use ripgrep to search inside emacs 
...
#+begin_src emacs-lisp
    (use-package projectile
      ...
      (projectile-project-search-path '("~/Source/rust/" "~/Source/clojure/" "~/Source/sql/" "~/Source/golang/" ("~/github" . 1)))) ;; . 1 means only search the first subdirectory level for projects
    ;; Use Bookmarks for smaller, not standard project
...
** Vterm-Toggle
  Toggle between the vterm buffer and whatever buffer you are editing.
